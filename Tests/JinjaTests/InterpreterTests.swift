...
struct InterpreterTests {
    ...
    struct GlobalsTests {
        ...
        func testStrftimeNowBasic() throws {
        ...
        func testStrftimeNowTime() throws {
        ...
        func testStrftimeNowWeekday() throws {
        ...
        func testStrftimeNowComplex() throws {
            ...
            let regex = try NSRegularExpression(pattern: "\\w+, \\w+ \\d{1,2}, \\d{4} at \\d{1,2}:\\d{2} (AM|PM)")
            let range = NSRange(location: 0, length: dateString.utf16.count)
            let matches = regex.firstMatch(in: dateString, range: range)
            #expect(matches != nil, "Complex date format should match expected pattern, got: \(dateString)")
        }

        @Test("strftime_now() with literal percent")
        func testStrftimeNowLiteralPercent() throws {
        ...
        func testStrftimeNowNoArguments() throws {
            #expect(throws: JinjaError.self) {
        ...
        func testStrftimeNowTooManyArguments() throws {
            #expect(throws: JinjaError.self) {
        ...
        func testStrftimeNowNonStringArgument() throws {
            #expect(throws: JinjaError.self) {
